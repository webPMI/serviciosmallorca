...
## 🥇 Las 15 Golden Rules Obligatorias (`docs/GOLDEN_RULES.md`)
...
11. **GR-11 (Zero Fake Data & Transparencia):** Cero inventos de datos o badges engañosos. Indicar honestamente datos de fuentes públicas/IA hasta que el titular verifique su ficha.
12. **GR-12 (Fidelidad Multi-Mapas):** Enlaces y datos oficiales a Google Maps, Apple Maps y Bing Maps.
13. **GR-13 (Seguridad & Privacidad):** HTTPS estricto, cabeceras de seguridad y reglas Firestore seguras.
14. **GR-14 (Sincronización Pre-Flight):** Verificar el estado del repositorio antes de comenzar.
...
| Documento                                                             | Contenido                                                 |
| --------------------------------------------------------------------- | --------------------------------------------------------- |
| [GOLDEN_RULES.md](docs/GOLDEN_RULES.md)                               | 🥇 Reglas inmutables (15 reglas completas)                |
