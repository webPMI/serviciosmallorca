...
| ------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- |
| **[GOLDEN_RULES.md](GOLDEN_RULES.md)**                                                     | 🥇 Reglas inmutables del proyecto (16 reglas incl. GR-15 Logs Resilientes D1 y GR-16 Versioning & Changelog)                  | Todos los agentes y desarrolladores |
| **[PERFECT_PAYMENTS_AND_HONOR_SYSTEM_SPEC.md](PERFECT_PAYMENTS_AND_HONOR_SYSTEM_SPEC.md)** | 👑 Arquitectura Maestra: Pagos, Idempotencia, Verificación de Titularidad y Cuadro de Honor (+1€)                             | @maestro, @frontend, @auth          |
...
| **[STRESS_TEST_PLAN.md](STRESS_TEST_PLAN.md)**                                             | 🧪 Plan de estrés & cobertura: campañas v1.x, hallazgos corregidos, umbrales CI y deuda consciente (rondas 1-2)               | @testing, @maestro                  |
...
| **[SPORTS_TECHNICAL_DESIGN.md](SPORTS_TECHNICAL_DESIGN.md)**                               | 🏗️ Diseño técnico de la vertical deportiva: separación de scrapers, activación de categorías e interfaces                     | @maestro, @frontend                 |
| **[AUCTION_HONOR_BOARD_SPEC.md](AUCTION_HONOR_BOARD_SPEC.md)**                             | ⚖️ Especificación técnica de subastas públicas, incrementos (+1€) y adjudicación de puestos en el Cuadro de Honor             | @frontend, @auth, @maestro          |
| **[AUDITOR_HANDOVER_REPORT.md](AUDITOR_HANDOVER_REPORT.md)**                               | 🛡️ Reporte de traspaso de auditoría multi-agente: estado del sistema, seguridad y métricas                                    | @maestro, todos                     |
| **[UTILITIES.md](UTILITIES.md)**                                                           | 🛠️ Ecosistema de utilidades gratuitas (toolkit) para usuarios de la plataforma                                                | @frontend, editores                 |
...
| **[USER_FEEDBACK_AND_COMMUNITY_VOICE.md](USER_FEEDBACK_AND_COMMUNITY_VOICE.md)**           | 📢 Voz de la Comunidad: sistema de feedback, quejas de comercios, sugerencias y buenas noticias (Fases F1-F3)                 | Todos los agentes, editores y dev   |
...
| **[CURATION_SOP.md](CURATION_SOP.md)**                                                     | 📋 SOP operativo de curación de datos y verificación de empresas en Mallorca                                                  | @curation                           |
| **[LEGAL_COMPLIANCE.md](LEGAL_COMPLIANCE.md)**                                             | ⚖️ Cumplimiento legal, RGPD, LOPDGDD, LSSI-CE y cookies en Baleares                                                           | @legal, @auth                       |
| **[EDUCATION_SECTION.md](EDUCATION_SECTION.md)**                                           | 🎓 Vertical de educación: colegios, academias, idiomas y centros de formación en Mallorca                                     | Editores, @frontend                 |
...
| **[GEMINI_BRIDGE.md](GEMINI_BRIDGE.md)**                                                   | 🔒 Puente local IA⇄Gemini con descubrimiento de modelos en vivo y análisis de comunicación                                    | @maestro, @curation, dev            |
