...
export const ginEvaMallorcaArtisanDistillery: ServiceItem = {
  id: "gin-eva-mallorca-artisan-distillery",
  slug: "gin-eva-mallorca-artisan-distillery",
  name: "Gin Eva Mallorca Artisan Botanical Distillery",
  category: "bodegas-enoturismo",
  sectorId: "agricultura-productores",
  culturalIdentity: "international_luxury",
  zone: "santanyi-migjorn",
  address: "Carrer del Gremi de Sabaters, 21, 07620 Llucmajor, Illes Balears",
