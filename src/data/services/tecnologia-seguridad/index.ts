...
export { trablisaSeguridad, digitalCinemaMallorca, electricidadBinissalem };
 ...
 */
export const SEGURIDAD_SERVICES: ServiceItem[] = [trablisaSeguridad, digitalCinemaMallorca, electricidadBinissalem];
