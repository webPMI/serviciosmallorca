...
import { agromart_balear_sineu } from "./agromart-balear-sineu.ts";
import { banyBanulsInteriorBathroomsPalma } from "./bany-banuls-interior-bathrooms-palma.ts";
import { bconnected_concept_store_santa_catalina } from "./bconnected-concept-store-santa-catalina.ts";
import { calzados_bestard_mountain_boots_lloseta_inca } from "./calzados-bestard-mountain-boots-lloseta-inca.ts";
import { can_sopa_mercat_olivar_palma } from "./can-sopa-mercat-olivar-palma.ts";
import { casa_lima_palma_muebles_diseno } from "./casa-lima-palma-muebles-diseno.ts";
...
import { cortana_palma_alta_costura_mediterranea } from "./cortana-palma-alta-costura-mediterranea.ts";
...
export { bconnected_concept_store_santa_catalina } from "./bconnected-concept-store-santa-catalina.ts";
export { calzados_bestard_mountain_boots_lloseta_inca } from "./calzados-bestard-mountain-boots-lloseta-inca.ts";
export { can_sopa_mercat_olivar_palma } from "./can-sopa-mercat-olivar-palma.ts";
export { casa_lima_palma_muebles_diseno } from "./casa-lima-palma-muebles-diseno.ts";
...
export { cortana_palma_alta_costura_mediterranea } from "./cortana-palma-alta-costura-mediterranea.ts";
...
export const RETAIL_SERVICES: ServiceItem[] = [
  agromart_balear_sineu,
  banyBanulsInteriorBathroomsPalma,
  bconnected_concept_store_santa_catalina,
  calzados_bestard_mountain_boots_lloseta_inca,
  can_sopa_mercat_olivar_palma,
  casa_lima_palma_muebles_diseno,
  ceramica_artesana_ca_n_oliver_sineu_alfares,
  colmadoSantoDomingoPalma,
  cortana_palma_alta_costura_mediterranea,
