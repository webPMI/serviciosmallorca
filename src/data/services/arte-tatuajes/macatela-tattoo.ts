...
export const macatelaTattoo: ServiceItem = {
  ...
  subcategories: ["traditional", "neotradicional", "blackwork", "lettering", "anime-manga", "piercing-titanio"],
  shortDescription: {
  ...
  highlights: {
    es: [
      ...
      "Perforaciones higiénicas y joyería esterilizada",
      "Espacio acogedor y trato personalizado",
    ],
    en: [
      "Central location on pedestrian Carrer dels Oms in Palma",
      "Specialists in classic American traditional and solid blackwork",
      "Sterile piercing procedures with certified titanium jewelry",
      "Friendly atmosphere and custom bespoke sketch development",
    ],
    ca: [
      "Ubicació cèntrica al carrer dels Oms de Palma",
      "Especialistes en estil tradicional americà i blackwork",
      "Perforacions higièniques i joieria esterilitzada",
      "Espai acollidor i tracte proper",
    ],
    de: [
      "Zentrale Lage in der beliebten Fußgängerzone Carrer dels Oms in Palma",
      "Spezialisiert auf Neotraditional, Anime-Motive und kontrastreiches Blackwork",
      "Individuelle Motivbesprechung und passgenaue Entwurfsarbeit",
      "Moderne, sterile Arbeitsplätze nach strengen Hygienestandards",
    ],
  },
  servicesProvided: {
    es: [
      ...
      "Piercing Corporal y Joyería",
    ],
    en: [
      "American Traditional Tattooing",
      "Blackwork & Geometric Ink",
      "Neotraditional & Bold Color",
      "Custom Lettering & Calligraphy",
