...
export const hotelEsMoliDeiaCove: ServiceItem = {
  id: "hotel-es-moli-deia-cove",
  slug: "hotel-es-moli-deia-cove",
  name: "Hotel Es Moli Deia",
  category: "hoteles-boutique-agroturismo",
  sectorId: "alojamiento-turismo",
  culturalIdentity: "mallorquin_heritage",
  zone: "tramuntana",
  address: "Ctra. Valldemossa - Deia, km 59.8, 07179 Deia, Illes Balears",
