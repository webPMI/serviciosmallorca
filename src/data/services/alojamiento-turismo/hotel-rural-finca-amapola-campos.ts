...
export const hotelRuralFincaAmapolaCampos: ServiceItem = {
  id: "hotel-rural-finca-amapola-campos",
  slug: "hotel-rural-finca-amapola-campos",
  name: "Finca Amapola Hotel & Spa Campos",
  category: "hoteles-boutique-agroturismo",
  sectorId: "alojamiento-turismo",
  culturalIdentity: "mallorquin_heritage",
  zone: "santanyi-migjorn",
  address: "Diseminado Tercera Vuelta, 12, 07630 Campos, Illes Balears",
