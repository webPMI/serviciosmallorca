...
export const fusterSegurosCorreduriaPalma: ServiceItem = {
  id: "fuster-seguros-correduria-palma",
  slug: "fuster-seguros-correduria-palma",
  name: "Fuster Correduría de Seguros Palma (1940)",
  category: "corredurias-seguros",
  sectorId: "finanzas-seguros",
  culturalIdentity: "mallorquin_heritage",
  zone: "palma",
  address: "Avinguda d'Alemanya, 14, 07003 Palma, Illes Balears",
