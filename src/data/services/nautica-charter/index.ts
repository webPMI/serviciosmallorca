...
export { portDeSollerMarinaService } from "./port-de-soller-marina.ts";
export { clubNauticPortocolomService } from "./portocolom-yacht-club.ts";
export { puertoPortalsMarina } from "./puerto-portals-marina.ts";
export { realClubNauticoPalma } from "./real-club-nautico-palma.ts";
export { reialClubNauticPortPollenca } from "./reial-club-nautic-port-pollenca.ts";
