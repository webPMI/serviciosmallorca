...
export const boschCarServicePalmaCentro: ServiceItem = {
  id: "bosch-car-service-palma-centro",
  slug: "bosch-car-service-palma-centro",
  name: "Taller Mecánico Bosch Car Service Palma",
  category: "motor-transporte",
  sectorId: "motor-transporte",
  culturalIdentity: "mallorquin_heritage",
  zone: "palma",
  address: "Carrer del Gremi de Teixidors, 18, Polígon Son Castelló, 07009 Palma",
