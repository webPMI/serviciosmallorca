...
export const CROSSFIT_DRAGON_PALMA: ServiceItem = {
  ...
  whatsapp: "+34 677 889 900",
  email: "info@crossfitdragon.es",
  website: "https://crossfitdragon.es",
