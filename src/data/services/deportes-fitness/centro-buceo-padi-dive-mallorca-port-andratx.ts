...
export const centro_buceo_padi_dive_mallorca_port_andratx: ServiceItem = {
  id: "centro-buceo-padi-dive-mallorca-port-andratx",
  ...
  whatsapp: "+34 971 672 584",
  email: "info@divemallorca.com",
