...
export const eurocampusDeutscheSchulePalma: ServiceItem = {
  id: "eurocampus-deutsche-schule-palma",
  slug: "eurocampus-deutsche-schule-palma",
  name: "Eurocampus Deutsche Schule Mallorca",
  category: "escuelas-internacionales",
  sectorId: "educacion-formacion",
  culturalIdentity: "german_oriented",
  zone: "palma",
  address: "Carrer del Llaüt, s/n, 07610 Palma, Illes Balears (Platja de Palma)",
