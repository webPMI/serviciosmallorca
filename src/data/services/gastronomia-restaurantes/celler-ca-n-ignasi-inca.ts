...
export const cellerCaNIgnasiInca: ServiceItem = {
  id: "celler-ca-n-ignasi-inca",
  slug: "celler-ca-n-ignasi-inca",
  name: "Celler Ca n'Ignasi Inca",
  category: "gastronomia-catering",
  sectorId: "hosteleria-gastronomia",
  culturalIdentity: "mallorquin_heritage",
  zone: "raiguer-pla",
  address: "Carrer de les Virtuts, 4, 07300 Inca, Illes Balears",
