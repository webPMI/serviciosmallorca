...
export const saLlumRestaurantPollensa: ServiceItem = {
  id: "sa-llum-restaurant-pollensa",
  slug: "sa-llum-restaurant-pollensa",
  name: "Restaurante Sa Llum Pollença",
  category: "gastronomia-catering",
  sectorId: "hosteleria-gastronomia",
  culturalIdentity: "mallorquin_heritage",
  zone: "alcudia-pollensa",
  address: "Carrer d'en Roca, 12, 07460 Pollença, Illes Balears",
