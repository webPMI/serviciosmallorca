...
export function initScrollAwareNavbar(options: ScrollAwareOptions = {}): () => void {
  const {
    threshold = 80,
    tolerance = 10,
  ...
  const navbars: HTMLElement[] = Array.from(document.querySelectorAll<HTMLElement>(selector));
